...
import {
  LayoutDashboard, User, Package, Heart, Settings,
  LogOut, Menu, X, Bell, Sun, Moon, ChevronDown, Sparkles
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex">
      ...
      <aside className={clsx(
        'fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 flex flex-col transition-transform duration-300',
        ...
        <div className="p-5 border-b border-gray-100 dark:border-gray-800">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">User Dashboard</p>
        </div>

        {/* User info */}
        <div className="p-4 border-b border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl">
            <div className="w-9 h-9 bg-gradient-to-br from-primary-500 to-accent-500 rounded-lg flex items-center justify-center text-white font-bold text-sm">
        ...
        <div className="p-4 border-t border-gray-100 dark:border-gray-800 space-y-1">
          <Link href="/" className="sidebar-link text-sm">
            <Sparkles className="w-4 h-4" /> Back to Store
          </Link>
          <button onClick={handleLogout} className="sidebar-link w-full text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20">
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-30 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 h-16 flex items-center px-4 sm:px-6 gap-4">
          ...
          <div className="relative">
            <button onClick={() => setProfileOpen(!profileOpen)} className="flex items-center gap-2 p-1.5 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
            ...
            {profileOpen && (
              <div className="absolute right-0 top-full mt-2 w-44 bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden z-50">
                <Link href="/dashboard/user/profile" onClick={() => setProfileOpen(false)} className="flex items-center gap-2 px-4 py-2.5 text-sm hover:bg-gray-50 dark:hover:bg-gray-800">
                  <User className="w-4 h-4" /> Profile
                </Link>
                <Link href="/dashboard/user/settings" onClick={() => setProfileOpen(false)} className="flex items-center gap-2 px-4 py-2.5 text-sm hover:bg-gray-50 dark:hover:bg-gray-800">
